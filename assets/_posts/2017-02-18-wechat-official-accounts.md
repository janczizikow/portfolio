...
Features marked with * are available, but with limited functionality.

## Account Registration

The registration is free and done remotely through the backend platform. But, don’t get too excited, because you’ll need a bunch of documents. And if you’re a foreigner this can be a bit tricky. For personal Chinese Wei Xin Official Account, you will need a photo of a Chinese ‘account manager’ holding their Chinese ID, a scan of that very ID, a scan of Chinese residence ID card, and bank card with the same name linked to WeChat wallet. For the business accounts in addition to the above, you need to provide the scan of Chinese business license and a scan of [filled in authorization letter](https://mp.weixin.qq.com/mpres/zh_CN/htmledition/doc/xxdjb_shou_quan_yun_ying-.doc). Doesn’t matter if its WOFE, Joint Venture or limited liability partnership, As long as the company is registered in mainland China it’s fine. Finally, the bank account owner has to transfer 1RMB to WeChat (Tencent) to finish the registration process.

## Summary

When it comes to choosing the type of account, there are no right or wrong decisions. Everything depends on how you wish to use it. Generally, if you focus your marketing strategy on pushing the content, Subscription account could be the most optimal one. If you wish to integrate more advanced features like linking the interactive menu to external mini-web pages or even adding some of the e-commerce functionality, Service account can be just what you need.


<div class="share">
  <a target="_blank" rel="noopener external" href="https://www.facebook.com/sharer/sharer.php?u=https%3A//www.janczizikow.com/wechat-official-accounts/" class="facebook">
    <span>
  ...
  <a target="_blank" rel="noopener external" href="https://plus.google.com/share?url=https%3A//www.janczizikow.com/wechat-official-accounts/" class="google-plus">
    <span>
      <svg version="1.1" id="google-plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 20" style="enable-background:new 0 0 26 20;" xml:space="preserve"><path d="M16,10.2c0,4.4-3,7.6-7.5,7.6c-4.3,0-7.8-3.5-7.8-7.8s3.5-7.8,7.8-7.8c2.1,0,3.9,0.8,5.2,2l-2.1,2c-0.6-0.6-1.6-1.2-3.1-1.2
        ...
        h-2.2v-2.2h-2.2V8.9h2.2V6.7H23v2.2H25.2z"/>
      </svg>
      Share
    </span>
  </a>
  <a target="_blank" rel="noopener external" href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A//www.janczizikow.com/wechat-official-accounts/&title=WeChat%20Official%20Accounts&summary=All%20you%20need%20to%20know%20about%20WeChat%20Official%20Accounts%20-%20differences,%20features,%20verifications.%20Learn%20which%20one%20to%20choose%20and%20how%20to%20register%20it.&source=https%3A//www.janczizikow.com/" class="linkedin">
    <span>
  ...
  <a target="_blank" rel="noopener external" href="https://pinterest.com/pin/create/button/?url=https%3A//www.janczizikow.com/wechat-official-accounts/&media=https%3A//www.janczizikow.com/assets/img/posts/wechat-official-accounts/wechat-official-accounts.jpg&description=All%20you%20need%20to%20know%20about%20WeChat%20Official%20Accounts%20-%20differences,%20features,%20verifications.%20Learn%20which%20one%20to%20choose%20and%20how%20to%20register%20it." class="pinterest">
    <span>
      ...
      <path d="M15.5,7.8c0,4.1-3.4,7.5-7.5,7.5c-0.7,0-1.4-0.1-2.1-0.3c0.3-0.5,0.6-1,0.8-1.6c0,0,0.1-0.3,0.5-2.1c0.3,0.5,1,0.9,1.8,0.9
        c2.4,0,4.1-2.2,4.1-5.2c0-2.2-1.9-4.3-4.8-4.3c-3.6,0-5.4,2.6-5.4,4.7c0,1.3,0.5,2.4,1.5,2.9c0.2,0.1,0.3,0,0.4-0.2
        c0-0.1,0.1-0.5,0.2-0.6c0-0.2,0-0.3-0.1-0.4C4.6,8.8,4.4,8.4,4.4,7.7c0-1.9,1.4-3.6,3.7-3.6c2,0,3.1,1.2,3.1,2.9c0,2.2-1,4-2.4,4
        C8,11,7.5,10.3,7.6,9.5c0.2-0.9,0.7-2,0.7-2.7c0-0.6-0.3-1.1-1-1.1c-0.8,0-1.4,0.8-1.4,1.9c0,0,0,0.7,0.2,1.2c-0.8,3.5-1,4.1-1,4.1
        C5,13.5,5,14.2,5,14.7c-2.7-1.2-4.5-3.8-4.5-6.9c0-4.1,3.4-7.5,7.5-7.5S15.5,3.7,15.5,7.8z"/>
      </svg>
      Share
    </span>
  </a>
